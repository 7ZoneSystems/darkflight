...
IRAM_ATTR static esp_err_t _rmt_fill_tx_items(rmt_channel_t channel, const rmt_item32_t* item, uint16_t item_num,
                                              uint16_t mem_offset)
{
...
EscDriverEsp32::EscDriverEsp32()
    : _protocol(ESC_PROTOCOL_PWM), _async(true), _rate(50), _digital(false), _dshot_tlm(false), _channel_mask(0)
{
...
uint32_t EscDriverEsp32::getPulseMin() const
{
  ...
  {
    case ESC_PROTOCOL_PWM:
      return nsToTicks(1000 * 1000);
    case ESC_PROTOCOL_ONESHOT125:
      return nsToTicks(125 * 1000);
    case ESC_PROTOCOL_ONESHOT42:
      return nsToTicks(42 * 1000);
    case ESC_PROTOCOL_MULTISHOT:
      return nsToTicks(5 * 1000);
    case ESC_PROTOCOL_BRUSHED:
      return 0;
...
uint32_t EscDriverEsp32::getPulseMax() const
{
  ...
  {
    case ESC_PROTOCOL_PWM:
      return nsToTicks(2000 * 1000);
    case ESC_PROTOCOL_ONESHOT125:
      return nsToTicks(250 * 1000);
    case ESC_PROTOCOL_ONESHOT42:
      return nsToTicks(84 * 1000);
    case ESC_PROTOCOL_MULTISHOT:
      return nsToTicks(25 * 1000);
    case ESC_PROTOCOL_BRUSHED:
      return nsToTicks(_interval * 1000);
    case ESC_PROTOCOL_DSHOT150:
    case ESC_PROTOCOL_DSHOT300:
    case ESC_PROTOCOL_DSHOT600:
    default:
...
uint16_t EscDriverEsp32::getDshotPulse(uint32_t width) const
{
  ...
  {
    case ESC_PROTOCOL_DSHOT150:
      return nsToTicks(width * 4);
    case ESC_PROTOCOL_DSHOT300:
      return nsToTicks(width * 2);
    case ESC_PROTOCOL_DSHOT600:
      return nsToTicks(width * 1);
    case ESC_PROTOCOL_BRUSHED:
    case ESC_PROTOCOL_PWM:
    case ESC_PROTOCOL_ONESHOT125:
    case ESC_PROTOCOL_ONESHOT42:
