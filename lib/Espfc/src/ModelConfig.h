...
enum BlacboxLogField
{ // no more than 32, sync with FlightLogFieldSelect_e
...
public:
  ...
  PidConfig pid[FC_PID_ITEM_COUNT] = {
      ...
      [FC_PID_POS] = {.P = 35, .I = 10, .D = 0, .F = 0},     // POSHOLD_P * 100, POSHOLD_I * 100
      [FC_PID_POSR] = {.P = 60,
                       .I = 20,
                       .D = 0,
                       .F = 0}, // POSHOLD_RATE_P * 10, POSHOLD_RATE_I * 100, POSHOLD_RATE_D * 1000
  ...
  int8_t pin[PIN_COUNT] = {
...
#endif
      [PIN_BUTTON] = ESPFC_BUTTON_PIN,       [PIN_BUZZER] = ESPFC_BUZZER_PIN,       [PIN_LED_BLINK] = ESPFC_LED_PIN,
#ifdef ESPFC_SERIAL_0
      [PIN_SERIAL_0_TX] = ESPFC_SERIAL_0_TX, [PIN_SERIAL_0_RX] = ESPFC_SERIAL_0_RX,
#endif
#ifdef ESPFC_SERIAL_1
      [PIN_SERIAL_1_TX] = ESPFC_SERIAL_1_TX, [PIN_SERIAL_1_RX] = ESPFC_SERIAL_1_RX,
#endif
#ifdef ESPFC_SERIAL_2
      [PIN_SERIAL_2_TX] = ESPFC_SERIAL_2_TX, [PIN_SERIAL_2_RX] = ESPFC_SERIAL_2_RX,
#endif
#ifdef ESPFC_I2C_0
      [PIN_I2C_0_SCL] = ESPFC_I2C_0_SCL,     [PIN_I2C_0_SDA] = ESPFC_I2C_0_SDA,
#endif
#ifdef ESPFC_ADC_0
      ...
      [PIN_SPI_CS0] = ESPFC_SPI_CS_GYRO,     [PIN_SPI_CS1] = ESPFC_SPI_CS_BARO,     [PIN_SPI_CS2] = -1,
#endif
  };
  SerialPortConfig serial[SERIAL_UART_COUNT] = {
#ifdef ESPFC_SERIAL_USB
      [SERIAL_USB] = {.id = SERIAL_ID_USB_VCP,
                      .functionMask = ESPFC_SERIAL_USB_FN,
                      .baud = SERIAL_SPEED_115200,
                      .gpsBaud = SERIAL_SPEED_NONE,
                      .telemetryBaud = SERIAL_SPEED_NONE,
                      .blackboxBaud = SERIAL_SPEED_NONE},
#endif
#ifdef ESPFC_SERIAL_0
      [SERIAL_UART_0] = {.id = SERIAL_ID_UART_1,
                         .functionMask = ESPFC_SERIAL_0_FN,
                         .baud = ESPFC_SERIAL_0_BAUD,
                         .gpsBaud = SERIAL_SPEED_NONE,
                         .telemetryBaud = SERIAL_SPEED_NONE,
                         .blackboxBaud = ESPFC_SERIAL_0_BBAUD},
#endif
#ifdef ESPFC_SERIAL_1
      [SERIAL_UART_1] = {.id = SERIAL_ID_UART_2,
                         .functionMask = ESPFC_SERIAL_1_FN,
                         .baud = ESPFC_SERIAL_1_BAUD,
                         .gpsBaud = SERIAL_SPEED_NONE,
                         .telemetryBaud = SERIAL_SPEED_NONE,
                         .blackboxBaud = ESPFC_SERIAL_1_BBAUD},
#endif
#ifdef ESPFC_SERIAL_2
      [SERIAL_UART_2] = {.id = SERIAL_ID_UART_3,
                         .functionMask = ESPFC_SERIAL_2_FN,
                         .baud = ESPFC_SERIAL_2_BAUD,
                         .gpsBaud = SERIAL_SPEED_NONE,
                         .telemetryBaud = SERIAL_SPEED_NONE,
                         .blackboxBaud = ESPFC_SERIAL_2_BBAUD},
#endif
#ifdef ESPFC_SERIAL_SOFT_0
      [SERIAL_SOFT_0] = {.id = SERIAL_ID_SOFTSERIAL_1,
                         .functionMask = ESPFC_SERIAL_SOFT_0_FN,
                         .baud = SERIAL_SPEED_115200,
                         .gpsBaud = SERIAL_SPEED_NONE,
                         .telemetryBaud = SERIAL_SPEED_NONE,
                         .blackboxBaud = SERIAL_SPEED_NONE},
