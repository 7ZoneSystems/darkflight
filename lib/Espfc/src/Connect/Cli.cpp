...
const Cli::Param* Cli::initialize(ModelConfig& c)
{
  ...
  static const Param params[] = {
      ...
      Param("gps_provider", &c.gps.provider), Param("gps_sbas_mode", &c.gps.sbasMode),
      Param("gps_auto_config", &c.gps.autoConfig), Param("gps_auto_baud", &c.gps.autoBaud),
      ...
      Param("gps_poshold_gps_timeout", &c.gps.posHoldGpsTimeout),
      ...
      Param("pin_uart1_tx", &c.pin[PIN_SERIAL_0_TX]), Param("pin_uart1_rx", &c.pin[PIN_SERIAL_0_RX]),
#endif
      ...
      Param("pin_uart2_tx", &c.pin[PIN_SERIAL_1_TX]), Param("pin_uart2_rx", &c.pin[PIN_SERIAL_1_RX]),
#endif
      ...
      Param("pin_uart3_tx", &c.pin[PIN_SERIAL_2_TX]), Param("pin_uart3_rx", &c.pin[PIN_SERIAL_2_RX]),
#endif
#ifdef ESPFC_I2C_0
  ...
  else if (strcmp(cmd.args[0], "gps") == 0)
  {
    ...
    else if(cmd.args[1] && strcmp(cmd.args[1], "port") == 0 && cmd.args[2])
    {
      ...
      else
      {
        ...
        s.println("GPS UART changed; save and reboot");
      }
    }
    else
    {
